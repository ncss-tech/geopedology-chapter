...
A curated set of soil morphologic and laboratory characterization data correlated to the Clarksville soil series (Loamy-skeletal, siliceous, semiactive, mesic Typic Paleudults) is used throughout this chapter to demonstrate key functionality and visualization possibilities provided by the AQP suite of R packages. These data represent a very deep (> 150cm), somewhat excessively well drained soil of large extent (Missouri, USA) formed in pedisediments of cherty dolomite or cherty limestone [@kabrick_et_al_2008]. These soils typically occur on ridges and steep side slopes, spanning summit, shoulder, and backslope positions of an idealized 2D hillslope. Mean annual air temperature ranges from 13--15 degrees C, mean annual precipitation ranges from 1150--1250 mm, with most precipitation falling as rain. Native vegetation is mixed forest of black oak (*Q. velutina* Lam.), white oak (*Quercus alba* L.), blackjack oak (*Q. marilandica* Muench.), post oak (*Q. stellata* Wangenh.), shortleaf pine (*Pinus echinata* Mill.), black hickory (*Carya texana* Buckl.), sugar maple (*Acer saccharum* Marshall), and dogwood (*Cornus florida* L.).


<!-- consider a figure here of a profile + landscape -->
<!-- ask Kabrick for one of his favorites -->

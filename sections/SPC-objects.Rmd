...
#### "bracket" extraction methods (`x[i,j,k1,k2,...]`)
...
plotMultipleSPC(list(x[3, ], x[3, 1], x[3, 1:3], x[3, , .LAST]), 
                     args = list(
                       list(color = "soil_color", print.id = TRUE),
                       list(color = "soil_color", print.id = FALSE),
                       list(color = "soil_color", print.id = FALSE),
                       list(color = "soil_color", print.id = FALSE)
                     ),
                     group.labels = c("\nx[3,]", "\nx[3, 1]",
...
plotMultipleSPC(list(x[3,], glom(x[3,], 50, 100), trunc(x[3,], 50, 100)),
                args=list(list(max.depth = 250), list(max.depth = 250), list(max.depth = 250)),
                group.labels=c("x[3,]", "glom(x[3,], 50, 100)", "trunc(x[3,], 50, 100)"))

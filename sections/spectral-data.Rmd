...
# res2 <- subset(res1, res1$samp_name == "Pikeville")[1,]
...
abs <- as.numeric(strsplit(ressub[1, 1]$absorbance, ",")[[1]])
wav <- as.numeric(strsplit(ressub[1, 1]$wavelength_string, ",")[[1]])
plot(abs ~ wav,
...
abs <- as.numeric(strsplit(ressub[1, 2]$absorbance, ",")[[1]])
wav <- as.numeric(strsplit(ressub[1, 2]$wavelength_string, ",")[[1]])
lines(abs ~ wav, col = "blue")

# first rep, third horizon add line
abs <- as.numeric(strsplit(ressub[1, 3]$absorbance, ",")[[1]])
wav <- as.numeric(strsplit(ressub[1, 3]$wavelength_string, ",")[[1]])
lines(abs ~ wav, col = "red")

# first rep, fourth horizon add line
abs <- as.numeric(strsplit(ressub[1, 4]$absorbance, ",")[[1]])
wav <- as.numeric(strsplit(ressub[1, 4]$wavelength_string, ",")[[1]])

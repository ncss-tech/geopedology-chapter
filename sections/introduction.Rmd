...
As soil science and data science converge, georeferenced data on soil morphology, and physical and chemical properties have become more accessible in high-resolution soil survey databases. Soil survey provides significant information on the distribution of soils as they relate to soil parent materials.  Articulate description of the interactions of soil distribution, soil parent material and their connection to the larger surficial geologic deposits and lithology through a geomorphic lense adds value to soil survey products and integrates them for use by the broader earth science community.  The nexus of soil, soil parent materials and surficial geologic deposits comprise the dynamic interface between the biosphere and the lithosphere [@Wysocki_et_al_2005].  Although soil survey is grounded in a soil-landscape paradigm [@Hudson1992], the clear synthesis of soil parent material relationships to geomorphology has not always been concisely distilled or captured in soil survey products.  Data alone cannot support decisions, generate useful conclusions, or convey embedded relationships without analysis and processing.  The wide-array of data sources, formats, and conventions (even within a single institution) can further complicate efforts to synthesize soil information from soil data sources.  Growth in promising tools that link database APIs, spatial data, and enable the analysis of complex soil description data are expanding the potential for soil science data analysis within programming environments like R [@R].
...
<!-- The Ozark Highlands area is ecologically important due to the high degree of vegetation species diversity and endemism that occurs on this landscape [@USGS2009].
Interstratified sandstone, dolomite with silicified stromatolite algal and chert beds compose the Roubidoux formation, while the Gasconade formation is composed of dolomite with varying amounts of chert.
Stratigraphy of the region is comprised of the Ordovician-aged Roubidoux and Gasconade formations, and the Eminence formation of Cambrian age. -->  

...
As soil science and data science converge, georeferenced data on soil morphology, physical and chemical properties has become more accessible in high-resolution soil survey databases. Soil survey has historically provided significant information on the distribution and character of soil parent materials.  Articulate description of the interactions of soil distribution, soil parent material and surficial geologic deposits and lithology through a geomorphic lense adds value to soil survey products and integrates them for use by the broader earth science community.  Soil, parent material and surficial geologic deposits comprise the dynamic interface between the biosphere and the lithosphere [@Wysocki2005].  Although soil survey is grounded in a foundational soil geomorphic paradigm, the clear synthesis of parent material relationships and geomorphology has not always been concisely distilled or captured in soil survey products.  Data alone cannot support decisions, generate useful conclusions, or convey embedded relationships without analysis and processing.  The wide-array of data sources, formats, and conventions (even within a single institution) can further complicate a soil scientist's best efforts to synthesize soil information from soil data sources. Growth in promising tools that link database APIs, spatial data, and enable the analysis of complex soil description data are expanding the potential for soil science data analysis within programming environments like R [@R].

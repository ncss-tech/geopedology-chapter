...
```{r sketch-demo-figure, fig.cap="Here a series of GHL have been applied to soils of the Clarksville soil series from the Ozark Highlands, Missouri."}
...
```{r catena-sketches, fig.cap="caption here"}
